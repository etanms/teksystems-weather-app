...
class HttpService
  ...
  # List of HTTP request methods to be used as a parameter of the make_request method.
  ...
  def self.make_request(url:, method:, options: {})
    # Raise an exception if the method is not supported
    raise MethodNotSupportedError.new unless method_supported?(method)
